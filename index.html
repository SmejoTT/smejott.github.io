...
<head>
    ...
    <title>Adrián Trajlínek</title>
</head>
<body>
<section class="game">
    <div class="intro">
        <h1>To mi nedá pokoj</h1>
    ...
    <div class="grid fadeOut">
        ...
        <div class="b26">
            <button id="26">26</button>
        </div>
        <div class="b27">
            <button id="27">27</button>
        </div>
        <div class="b28">
            <button id="28">28</button>
        </div>
        <div class="b29">
            <button id="29">29</button>
        </div>
        <div class="b30">
        ...
        <div class="b34">
            <button id="34">34</button>
        </div>
        <div class="b35">
            <button id="35">35</button>
        </div>
        <div class="b36">
            <button id="36">36</button>
        </div>
        <div class="b37">
            <button id="37">37</button>
        </div>
    </div>
